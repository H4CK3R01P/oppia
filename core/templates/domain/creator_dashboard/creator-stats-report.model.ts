...
/**
 * @fileoverview Model for creator stats report.
 */
...
export class CreatorStatsReport {
  constructor(
    ...
    public explorations: ExplorationStats[]
  ) {}
  ...
  static createFromBackendDict(
    ...
    return new CreatorStatsReport(
      ...
      backendDict.explorations.map(expStats =>
        ExplorationStats.createFromBackendDict(expStats)
      )
    );
  }
}
